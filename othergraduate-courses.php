...
//    $filtercourses = $courses;
//    $sqlTitle = "SELECT * FROM `dc_postgraduate_images` where coruses_id = '$filtercourses' ORDER BY id ASC";
...
//  / echo  $sqlForCI;exit;
   ...
   $sqlF = "SELECT * FROM `dc_faculty`  where courses_category='$type' and coruses_id = '$filtercourses' ORDER BY id ASC";
   $resultF = $func->query($sqlF);

   
   $sqlL = "SELECT * FROM `dc_laboratory` where courses_category='$type' and coruses_id = '$filtercourses' ORDER BY id ASC";
   ...
   $sqlcimg = "SELECT * FROM `dc_subtype_courses_images`   where courses_category='$type' AND coruses_id = '$filtercourses'  ORDER BY created_at ASC";
   $resultcimg = $func->query($sqlcimg);

   

   $sqlV = "SELECT * FROM `dc_ourvision`  where courses_category='$type' and coruses_id = '$filtercourses' ";
   $resultV = $func->query($sqlV);
   $rowV = $func->fetch($resultV);
   
   $sqlM = "SELECT * FROM `dc_ourmission`  where courses_category='$type'  and coruses_id = '$filtercourses'";
   $resultM = $func->query($sqlM);
   $rowM = $func->fetch($resultM);
   
   $sqlG = "SELECT * FROM `dc_ourgoal`  where courses_category='$type' and coruses_id = '$filtercourses' ";
   $resultG = $func->query($sqlG);
...
<head>
    <title>Ics - ICS KHED | Other Details</title>
    <meta charset="UTF-8">
