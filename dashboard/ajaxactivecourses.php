...
//  session_start();
    ...
    while($row = $admin->fetch($sql))
    {
        ...
        $addURL_vision = 'undergraduate-vision-add.php';
        $deleteURL_vision = 'undergraduate-vision-delete.php';
        $y = (10*$pageNo)-9;
        ...
        $addURL_mission = 'undergraduate-mission-add.php';
        $deleteURL_mission = 'undergraduate-mission-add.php';
        $y = (10*$pageNo)-9;
        ...
        $addURL_goal = 'undergraduate-goal-add.php';
        $deleteURL_goal = 'undergraduate-goal-add.php';
        $y = (10*$pageNo)-9;
        ...
        //end of goal 
         ...
         $addURL_ST = 'subtype-courses-images-add.php';
         $deleteURL_ST = 'subtype-courses-images-delete.php';
        ...
        //  $sqlST = "Select * FROM dc_subtype_courses_images where coruses_id='".$course_id."' ";
         ...
         $addURL_faculty = 'faculty-add.php';
         $deleteURL_faculty = 'faculty-delete.php';
         $y = (10*$pageNo)-9;
         ...
         $addURL_lab = 'laboratory-add.php';
         $deleteURL_lab = 'laboratory-delete.php';
         $y = (10*$pageNo)-9;
        ...
        $addURL_curricular = 'studentcurricular-add.php';
        $deleteURL_curricular = 'studentcurricular-delete.php';
        $x = (10*$pageNo)-9;
        while($row = $admin->fetch($resultscurricular)){
         ...
         $addURL_academic = 'studentacademic-add.php';
         $deleteURL_academic = 'studentacademic-add.php';
         $x = (10*$pageNo)-9;
