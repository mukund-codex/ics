   ...
   $removeSelectedtabs = $admin->removeSelectedTabs();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addfaculty($_POST,'PG');
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueFacultyById($id , 'PG');
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updatefaculty($_POST);
			...
			<form role="form" action="" method="post" id="form" enctype="multipart/form-data">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title"><i class="icon-library"></i>Add Faculty</h6>
					</div>
						...
						<div class="row">
							...
							<div class="row">
                                ...
                                <label>Faculty Name <span style="color:red">*</span> </label>
									<textarea col="5" rows="4"  class="form-control" required  name="faculty_name" id="" /><?php if(isset($_GET['edit'])){ echo $data['name']; }?></textarea>
									<!-- <input type="text" class="form-control"  required  name="title" id="" value=""/> -->
								</div>
								
								<div class="col-sm-6">
									<label>Faculty Department <span style="color:red">*</span> </label>
									<textarea col="5" rows="4"  class="form-control" required  name="faculty_dept" id="" /><?php if(isset($_GET['edit'])){ echo $data['department']; }?></textarea>
									<!-- <input type="text" class="form-control"  required  name="title" id="" value=""/> -->
								</div>
                            ...
                            <div class="col-sm-6">
                                <label>Faculty Designation <span style="color:red">*</span> </label>
									<textarea col="5" rows="4"  class="form-control" required  name="faculty_desgi" id="" /><?php if(isset($_GET['edit'])){ echo $data['designation']; }?></textarea>
									<!-- <input type="text" class="form-control"  required  name="title" id="" value=""/> -->
								</div>
							</div>	
...
<?php 	include "include/footer.php"; ?>
	...
	var editor = CKEDITOR.replace( 'faculty_name', {
			height: 100,
		...
		var editor = CKEDITOR.replace( 'faculty_dept', {
			height: 100,
			filebrowserImageBrowseUrl : 'js/editor/ckfinder/ckfinder.html?type=Images',
			filebrowserImageUploadUrl : 'js/editor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
			toolbarGroups: [
        ...
        var editor = CKEDITOR.replace( 'faculty_desgi', {
			height: 100,
			filebrowserImageBrowseUrl : 'js/editor/ckfinder/ckfinder.html?type=Images',
			filebrowserImageUploadUrl : 'js/editor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
			toolbarGroups: [
