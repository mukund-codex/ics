<?php
	...
	$pageURL = 'othergraduate-vision-add.php';
   ...
   $removeSelectedtabs = $admin->removeSelectedTabs();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addForAll($_POST,$file,'addvision','Other');
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueAllById($id ,'getvision', 'Other');
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateForAll($_POST,$file,'updatevision','Other');
