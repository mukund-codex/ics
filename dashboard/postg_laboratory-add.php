<?php
	...
	$pageName = "Laboratory";
	$parentPageURL = 'postgraduate-courses-master.php';
	$pageURL = 'postg_laboratory-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addLaboratory($_POST,'PG');
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueLaboratoryById($id , 'PG');
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateLaboratory($_POST);
...
<?php			} ?>
			...
			<ul class="breadcrumb">
				<li><a href="postgraduate-courses-master.php">Home</a></li>
			...
			<form role="form" action="" method="post" id="form" enctype="multipart/form-data">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title"><i class="icon-library"></i>Add Laboratory</h6>
					</div>
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="row">
								<div class="col-sm-6">
                                <label>Name of Lab<span style="color:red">*</span> </label>
									<textarea col="5" rows="4"  class="form-control" required  name="lab_name" id="" /><?php if(isset($_GET['edit'])){ echo $data['lab_name']; }?></textarea>
									<!-- <input type="text" class="form-control"  required  name="title" id="" value=""/> -->
								</div>
								
								<div class="col-sm-6">
									<label>Lab Incharge<span style="color:red">*</span> </label>
									<textarea col="5" rows="4"  class="form-control" required  name="lab_incharge" id="" /><?php if(isset($_GET['edit'])){ echo $data['lab_incharge']; }?></textarea>
									<!-- <input type="text" class="form-control"  required  name="title" id="" value=""/> -->
								</div>
                            ...
                            <div class="col-sm-6">
                                <label>Contact Number<span style="color:red">*</span> </label>
									<textarea col="5" rows="4"  class="form-control" required  name="lab_contactno" id="" /><?php if(isset($_GET['edit'])){ echo $data['lab_contactno']; }?></textarea>
									<!-- <input type="text" class="form-control"  required  name="title" id="" value=""/> -->
								</div>
							</div>	
...
<?php 	include "include/footer.php"; ?>
	...
	var editor = CKEDITOR.replace( 'lab_name', {
			height: 100,
		...
		var editor = CKEDITOR.replace( 'lab_incharge', {
			height: 100,
			filebrowserImageBrowseUrl : 'js/editor/ckfinder/ckfinder.html?type=Images',
			filebrowserImageUploadUrl : 'js/editor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
			toolbarGroups: [
        ...
        var editor = CKEDITOR.replace( 'lab_contactno', {
			height: 100,
			filebrowserImageBrowseUrl : 'js/editor/ckfinder/ckfinder.html?type=Images',
			filebrowserImageUploadUrl : 'js/editor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
			toolbarGroups: [
