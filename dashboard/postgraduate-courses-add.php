<?php
	...
	$pageName = "Postgraduate Courses Images";
	$parentPageURL = 'postgraduate-courses-master.php';
	$pageURL = 'postgraduate-courses-add.php';
    // echo $_GET['id'];exit();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addUndergraduateCoursesDataImages($_POST,$_FILES,'PGC');
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueUndergraduateCoursesDataImagesById($id , 'PGC');
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateUndergraduateCoursesDataImages($_POST,$_FILES , 'PGC');
...
<body class="sidebar-wide">
    ...
    <div class="page-container">
		...
		-->
            ...
            <div class="breadcrumb-line">
                ...
                <ul class="breadcrumb">
                    <li><a href="<?php echo $parentPageURL; ?>">Home</a></li>
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i> Postgraduate Courses Images Add</h6>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
									...
									?>
                                    <img src="../img/Postgraduate/<?php echo $file_name.'_crop.'.$ext ?>" width="300"
                                        height="200" />
                                    <?php
									} ?>
    ...
    var editor = CKEDITOR.replace('dept_discp', {
        height: 200,
