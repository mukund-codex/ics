<?php
	...
	$pageURL = 'othergraduate-mission-add.php';
   ...
   $removeSelectedtabs = $admin->removeSelectedTabs();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addForAll($_POST,$file,'addmission','Other');
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueAllById($id ,'getmission', 'Other');
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateForAll($_POST,$file,'updatemission','Other');
