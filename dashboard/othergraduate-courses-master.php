<?php
	...
	$pageName = "Others Details";

	 $pageURL = 'othergraduate-courses-master.php';
	// $addURL = 'department-add.php';
	// $deleteURL = 'department-delete.php';
    //ugraduate_courses_images
	$tableName = 'departments';


  //faculty
	$tab_F = "Faculty";
    $addURL_F = 'other_faculty-add.php';
	$deleteURL_F = 'other_faculty-delete.php';
	$tableName_F = 'faculty';

	//Laboratory
	$tab_L = "Laboratory";
    $addURL_L = 'other_laboratory-add.php';
	$deleteURL_L = 'other_laboratory-delete.php';
	$tableName_L = 'laboratory';


    //Student Academic
    $tab_SA = "Student Academic Activities";
    $addURL_SA = 'other-studentacademic-add.php';
	$deleteURL_SA = 'other-studentacademic-delete.php';
	$tableName_SA = 'student_academic';

    //Student Co-Curricular
    $tab_SC = "Student Co-Curricular Activities";
    $addURL_SC = 'other-studentcurricular-add.php';
	$deleteURL_SC = 'other-studentcurricular-delete.php';
    ...
    //Vision 
	$tab_V = "Our Vision";
    $addURL_V = 'othergraduate-vision-add.php';
	$deleteURL_V = 'othergraduate-vision-delete.php';
	$tableName_V = 'ourvision';

    //Mission 
	$tab_M = "Our Mission";
    $addURL_M = 'othergraduate-mission-add.php';
	$deleteURL_M = 'othergraduate-mission-delete.php';
	$tableName_M = 'ourmission';


    //Goal
	$tab_G = "Our Goal";
    $addURL_G = 'othergraduate-goal-add.php';
	$deleteURL_G = 'othergraduate-goal-delete.php';
	$tableName_G = 'ourgoal';


    //add-title-description.php
    //ineed to check for it
    $addURL_titledes = 'other-add-title-description.php';
    $deleteURL_titledes = 'other-delete-title-description.php';
    $tableName_titledes = 'other-title_descrption';


    $addURL_CI = 'other-carousel-images-add.php';
    $deleteURL_CI = 'other-carousel-images-delete.php';
    $tableName_CI = 'other-carousel_images';


    //Add Subtype For Courses

    $addURL_subtype = 'other-subtype-courses-images-add.php';
    $deleteURL_subtype = 'other-subtype-courses-images-delete.php';
    $tableName_subtype = 'other-subtype_courses_images';
	...
	$sqlTitleDes = "Select * From dc_title_descrption where courses_category ='Other'";
	$results2 = $admin->query($sqlTitleDes);

	$sqlCI = "Select * From dc_carousel_images where courses_category ='Other'";
	$results3 = $admin->query($sqlCI);

    $sqlST = "SELECT `cat`.category,`sc`.* FROM `dc_subtype_courses_images` as sc ,`dc_category` as cat WHERE sc.`coruses_id`= cat.`coruses_id` and sc.courses_category ='Other'";
    ...
    $sqlForDepSC = "SELECT * FROM ".PREFIX.$tableName_SC."  Where courses_category = 'Other' ";
	$resultsSC = $admin->query($sqlForDepSC);

    $sqlForDepSA = "SELECT * FROM ".PREFIX.$tableName_SA."  Where courses_category = 'Other' ";
...
?>
                                <tr>
                                    ...
                                    <td><?php echo $row['coruses_name'] ?></td>
                                    <td><?php echo $row['title'] ?></td>
                                    <td><img src="../img/StudentCo-Curricular/postgraduate/<?php echo $file_name.'_crop.'.$ext ?>"
                                            width="100" /></td>
                                    <td><?php echo $row['created_at']; ?></td>
                                    <td><?php echo $row['updated_at']; ?></td>
                                    <td>
...
?>
                                <tr>
                                    ...
                                    <td><?php echo $row['coruses_name'] ?></td>
                                    <td><?php echo $row['title'] ?></td>
                                    <td><img src="../img/StudentAcademic/postgraduate/<?php echo $file_name.'_crop.'.$ext ?>"
                                            width="100" /></td>
                                    <td><?php echo $row['created_at']; ?></td>
                                    <td><?php echo $row['updated_at']; ?></td>
                                    <td>
...
?>
    ...
    $(function() {
        $("#sub_category1").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "otherajaxactivecourses.php",
                data: {
