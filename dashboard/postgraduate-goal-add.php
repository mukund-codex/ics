<?php
	...
	$pageURL = 'postgraduate-goal-add.php';
   ...
   $removeSelectedtabs = $admin->removeSelectedTabs();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addForAll($_POST,$file,'addgoal','PG');
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueAllById($id ,'getgoal', 'PG');
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateForAll($_POST,$file,'updategoal','PG');
...
<body class="sidebar-wide">
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i>Our Goal</h6>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <label>Our Goal <span style="color:red">*</span> </label>
                                    <textarea col="5" rows="4" class="form-control" required name="goal"
                                        id="" /><?php if(isset($_GET['edit'])){ echo $data['description']; }?></textarea>
    ...
    var editor = CKEDITOR.replace('goal', {
        height: 100,
