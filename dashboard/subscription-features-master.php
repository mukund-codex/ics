<?php
	...
	$pageName = "Subscription Features Master";
	$pageURL = 'subscription-features-master.php';
	$addURL = 'subscription-features-add.php';
	$deleteURL = 'subscription-features-delete.php';
	$tableName = 'subscription_features_master';
...
<?php
						...
						while($row = $func->fetch($results)){
							...
							$feature = $func->getUniqueFeatureById($row['feature_category']);
?>
							<tr>
								<td><?php echo $x++; ?></td>
								<td><?php echo $category['category_name']; ?></td>
								<td><?php echo strtoupper($package['package_name']); ?></td>
