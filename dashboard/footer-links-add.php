<?php
	...
	$pageName = "Footer";
	$parentPageURL = 'footer-links-master.php';
	$pageURL = 'footer-links-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addFooter($_POST,$_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueFooterById($id,$category);
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
            ...
            $category = $admin->escape_string($admin->strip_all($_GET['category']));
			$result = $admin->updateFooter($_POST ,$_FILES,$category);
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i>Add Admission</h6>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <label for="sel1">Select Admission</label>
                                    <?php  
                                    ...
                                    <?php } else{ ?>
                                        ...
                                        <option value="Our Institute">Our Institute</option>
