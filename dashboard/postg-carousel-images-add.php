<?php
	...
	$pageURL = 'postg-carousel-images-add.php';
    $type="PG";
    // echo $_GET['id'];exit();
   ...
   $removeSelectedtabs = $admin->removeSelectedTabs();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addDepartmentCarosel($_POST,$_FILES , $type);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueDepartmentCaroselById($id);
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateDepartmentCarosel($_POST,$_FILES);
