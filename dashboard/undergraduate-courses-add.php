<?php
	...
	$pageName = "Undergraduate Courses Images";
	$parentPageURL = 'undergraduate-courses-master.php';
	$pageURL = 'undergraduate-courses-add.php';
    // echo $_GET['id'];exit();
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i> Undergraduate Courses Images Add</h6>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
									...
									?>
                                    <img src="../img/Undergraduate/<?php echo $file_name.'_crop.'.$ext ?>" width="300"
                                        height="200" />
                                    <?php
									} ?>
