<?php
	...
	$pageURL = 'header-admission-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addAdmission($_POST,$_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueAdmissionById($id,$category);
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
            ...
            $category = $admin->escape_string($admin->strip_all($_GET['category']));
			$result = $admin->updateAdmission($_POST ,$_FILES,$category);
