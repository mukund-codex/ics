<?php
	...
	$pageURL = 'postgraduate-vision-add.php';
   ...
   $removeSelectedtabs = $admin->removeSelectedTabs();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addForAll($_POST,$file,'addvision','PG');
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueAllById($id ,'getvision', 'PG');
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateForAll($_POST,$file,'updatevision','PG');
...
<body class="sidebar-wide">
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i>Our Vision</h6>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea col="5" rows="4" class="form-control" required name="vision"
    ...
    var editor = CKEDITOR.replace('vision', {
        height: 100,
