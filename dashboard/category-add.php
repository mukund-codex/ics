							...
							<div class="row">
							  ...
							  <!--  -->
								...
								<div class="col-sm-4">
									...
									<input type="file" class="form-control" accept="image/jpg,image/png,image/jpeg" name="image_name" <?php if(!isset($_GET['edit'])) { echo 'required'; } ?> id="" data-image-index="0" />
									<br>
									<span class="help-text">
										Files must be less than <strong>2 MB</strong>.<br>
										Allowed file types: <strong>png jpg jpeg</strong>.<br>
										Images must be exactly <strong>222x27</strong> pixels.
									</span><br>
