<?php
	...
	$pageURL = 'header-studentcorner-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addStudentCorner($_POST,$_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueStudentCornerById($id,$category);
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
            ...
            $category = $admin->escape_string($admin->strip_all($_GET['category']));
			$result = $admin->updateStudentCorner($_POST ,$_FILES,$category);
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i>Add Student Croner</h6>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <label for="sel1">Select Student Croner</label>
                                    <?php  
                                    ...
                                    <?php } else{ ?>
                                        ...
                                        <option value="0">Select Student Croner</option>
