<?php
	...
	$pageName = "Quick Wash Master";
	$pageURL = 'quick-wash-master.php';
	$addURL = 'quick-wash-add.php';
	$deleteURL = 'quick-wash-delete.php';
	$tableName = 'quick_wash_master';
...
?>
							<tr>
								<td><?php echo $x++; ?></td>
								<td> <img src="../img/quick-wash/<?php echo $file_name.'_crop.'.$ext ?>" style="height:100px;width:100px"> </td>
								<td><?php echo $category['category_name']; ?></td>
                                <td><?php echo $row['time']; ?></td>
								<td><?php echo $row['main_features']; ?></td>
								<td><?php echo $row['interior_feature']; ?></td>
								<td><?php echo $row['exterior_feature']; ?></td>		
