<?php
	...
	$pageURL = 'sub-courses-add-title-description.php';
    // echo $_GET['id'];exit();
   ...
   // exit;
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			// print_r($_POST);exit;
			$result = $admin->addDepartmentSubTypeTitleDes($_POST);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueDepartmentSubTypeTitleDesById($id);
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateDepartmentSubTypeTitleDes($_POST);
