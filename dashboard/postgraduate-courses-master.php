<?php
	...
	$pageName = "PostGraduate Details";

	 $pageURL = 'postgraduate-courses-master.php';
  ...
  //faculty
	$tab_F = "Faculty";
    $addURL_F = 'postg_faculty-add.php';
	$deleteURL_F = 'postg_faculty-delete.php';
	$tableName_F = 'faculty';

	//Laboratory
	$tab_L = "Laboratory";
    $addURL_L = 'postg_laboratory-add.php';
	$deleteURL_L = 'postg_laboratory-delete.php';
	$tableName_L = 'laboratory';


    //Student Academic
    $tab_SA = "Student Academic Activities";
    $addURL_SA = 'postg-studentacademic-add.php';
	$deleteURL_SA = 'postg-studentacademic-delete.php';
	$tableName_SA = 'student_academic';

    //Student Co-Curricular
    $tab_SC = "Student Co-Curricular Activities";
    $addURL_SC = 'postg-studentcurricular-add.php';
	$deleteURL_SC = 'postg-studentcurricular-delete.php';
    ...
    //Vision 
	$tab_V = "Our Vision";
    $addURL_V = 'postgraduate-vision-add.php';
	$deleteURL_V = 'postgraduate-vision-delete.php';
	$tableName_V = 'ourvision';

    //Mission 
	$tab_M = "Our Mission";
    $addURL_M = 'postgraduate-mission-add.php';
	$deleteURL_M = 'postgraduate-mission-delete.php';
	$tableName_M = 'ourmission';


    //Goal
	$tab_G = "Our Goal";
    $addURL_G = 'postgraduate-goal-add.php';
	$deleteURL_G = 'postgraduate-goal-delete.php';
	$tableName_G = 'ourgoal';


    //add-title-description.php
    //ineed to check for it
    $addURL_titledes = 'postg-add-title-description.php';
    $deleteURL_titledes = 'postg-delete-title-description.php';
    $tableName_titledes = 'postg-title_descrption';


    $addURL_CI = 'postg-carousel-images-add.php';
    $deleteURL_CI = 'postg-carousel-images-delete.php';
    $tableName_CI = 'postg-carousel_images';


    //Add Subtype For Courses

    $addURL_subtype = 'postg-subtype-courses-images-add.php';
    $deleteURL_subtype = 'postg-subtype-courses-images-delete.php';
    $tableName_subtype = 'postg-subtype_courses_images';
	...
	$sqlTitleDes = "Select * From dc_title_descrption where courses_category ='PG'";
	$results2 = $admin->query($sqlTitleDes);

	$sqlCI = "Select * From dc_carousel_images where courses_category ='PG'";
	$results3 = $admin->query($sqlCI);

    $sqlST = "SELECT `cat`.category,`sc`.* FROM `dc_subtype_courses_images` as sc ,`dc_category` as cat WHERE sc.`coruses_id`= cat.`coruses_id` and sc.courses_category ='PG'";
    ...
    $sqlForDepSC = "SELECT * FROM ".PREFIX.$tableName_SC."  Where courses_category = 'PGC' ";
	$resultsSC = $admin->query($sqlForDepSC);

    $sqlForDepSA = "SELECT * FROM ".PREFIX.$tableName_SA."  Where courses_category = 'PGC' ";
