<?php
	...
	$pageURL = 'contact_form.php';
	$addURL = 'contact_form-add.php';
	$deleteURL = 'contact_form-delete.php';
	...
	<?php
		if(isset($_GET['updatesuccess'])){ ?>
			<div class="alert alert-success alert-dismissible" role="alert">
				...
				<i class="icon-checkmark"></i> Contact Form successfully updated.
			</div><br/>
	<?php	} ?>
	<?php
	...
	<?php	} ?>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h6 class="panel-title"><i class="icon-stats"></i> Contact Detail</h6>
				</div>
				<div class="panel-body">
				<a href="<?php echo $addURL; ?>" class="label label-primary pull-right">Add <?php echo $pageName; ?></a>
					<?php 
					
					$activeCount = $admin->num_rows($admin->query("SELECT * FROM ".PREFIX."contact_detail"));
					//echo $activeCount;
					if($activeCount<7){
					?>
