...
<head>
	...
	<title><?php echo TITLE ?></title><link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
	...
	<?php	} ?>
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading">
					...
					<h6 class="panel-title"><i class="icon-stats"></i> Contact Form</h6>
...
?>
								...
								<tr>
									...
									<td>
										...
										<a class="" href="contact-form-delete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete?');" title="Click to delete this row, this action cannot be undone."><i class="icon-remove3"></i></a>
