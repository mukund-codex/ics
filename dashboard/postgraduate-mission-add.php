<?php
	...
	$pageURL = 'postgraduate-mission-add.php';
   ...
   $removeSelectedtabs = $admin->removeSelectedTabs();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addForAll($_POST,$file,'addmission','PG');
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueAllById($id ,'getmission', 'PG');
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateForAll($_POST,$file,'updatemission','PG');
...
<body class="sidebar-wide">
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i>Our Mission</h6>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea col="5" rows="4" class="form-control" required name="mission"
    ...
    var editor = CKEDITOR.replace('mission', {
        height: 100,
