<?php
	...
	$pageName = "Student Academic Activities";
	$parentPageURL = 'postgraduate-courses-master.php';
	$pageURL = 'postg-studentacademic-add.php';
   ...
   $removeSelectedtabs = $admin->removeSelectedTabs();
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addStudentAcademic($_POST,$_FILES,'PGC');
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueStudentAcademicById($id , 'PGC');
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateStudentAcademic($_POST,$_FILES,'PGC');
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i>Student Academic</h6>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="file" class="form-control" name="stdacd_img"
									...
									?>
                                    Previous Image : <br><img
                                        src="../img/StudentAcademic/postgraduate/<?php echo $file_name.'_crop.'.$ext ?>"
                                        width="100" /><br><br>
                                    <?php
									} ?>
                                </div>
