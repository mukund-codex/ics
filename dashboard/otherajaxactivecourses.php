...
//  session_start();
    ...
    while($row = $admin->fetch($sql))
    {
        ...
        $addURL_vision = 'othergraduate-vision-add.php';
        $deleteURL_vision = 'othergraduate-vision-delete.php';
        $y = (10*$pageNo)-9;
        ...
        $addURL_mission = 'othergraduate-mission-add.php';
        $deleteURL_mission = 'othergraduate-mission-add.php';
        $y = (10*$pageNo)-9;
        ...
        $addURL_goal = 'othergraduate-goal-add.php';
        $deleteURL_goal = 'othergraduate-goal-add.php';
        $y = (10*$pageNo)-9;
        ...
        //end of goal 
         ...
         $addURL_TD = 'other-add-title-description.php';
         $deleteURL_TD = 'other-delete-title-description.php';
         $y = (10*$pageNo)-9;
         ...
         $addURL_ST = 'other-subtype-courses-images-add.php';
         $deleteURL_ST = 'other-subtype-courses-images-delete.php';
        ...
        //  $sqlST = "Select * FROM dc_subtype_courses_images where coruses_id='".$course_id."' ";
         ...
         $addURL_faculty = 'other_faculty-add.php';
         $deleteURL_faculty = 'other_faculty-delete.php';
         $y = (10*$pageNo)-9;
         ...
         $addURL_lab = 'other_laboratory-add.php';
         $deleteURL_lab = 'other_laboratory-delete.php';
         $y = (10*$pageNo)-9;
        ...
        $addURL_curricular = 'other-studentcurricular-add.php';
        $deleteURL_curricular = 'other-studentcurricular-delete.php';
        $x = (10*$pageNo)-9;
        while($row = $admin->fetch($resultscurricular)){
            ...
            $curricular .=  '<td><img src="../img/StudentCo-Curricular/postgraduate/'.$file_name.'_crop.'.$ext.'"
            width="100" /></td>';
         ...
         $addURL_academic = 'other-studentacademic-add.php';
         $deleteURL_academic = 'other-studentacademic-add.php';
         $x = (10*$pageNo)-9;
         while($row = $admin->fetch($resultsacademic)){
             ...
             $academic .=  '<td><img src="../img/StudentAcademic/postgraduate/'.$file_name.'_crop.'.$ext.'"
             width="100" /></td>';
