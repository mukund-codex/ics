<?php
	...
	$pageName = "Carousel Images";
	$parentPageURL = 'department-master.php';
	$pageURL = 'sub-coruses-carousel-images-add.php';
    // echo $_GET['id'];exit();
   ...
   $removeSelectedtabs = $admin->removeSelectedTabs();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addDepartmentSubCoursesCarosel($_POST,$_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueDepartmentSubCoursesCaroselById($id);
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateDepartmentSubCoursesCarosel($_POST,$_FILES);
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i> Department Add</h6>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
									...
									?>
                                    <img src="../img/Department/subcoursestype/<?php echo $file_name.'_crop.'.$ext ?>" width="300"
                                        height="200" />
                                    <?php
									} ?>
