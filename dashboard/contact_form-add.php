<?php
	...
	$pageName = "Contact";
	$parentPageURL = 'contact_form.php';
	$pageURL = 'contact_form-add.php';
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateContact($_POST);
			...
			<form role="form" action="" method="post" id="form" enctype="multipart/form-data">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title"><i class="icon-library"></i> Contact Details</h6>
					</div>
					<div class="panel-body">
						<div class="form-group">
						<div class="row">
						        <div class="col-sm-3">
									<label>Position Title<span style="color:red">*</span> </label>
									<input class="form-control" required placeholder="Position Title"  name="pos_title"    value="<?php if(!empty($data['pos_title'])){ echo $data['pos_title']; }?>" />
								</div>

								<div class="col-sm-3">
									<label>Prof. Name<span style="color:red">*</span> </label>
									<input class="form-control" required placeholder="Prof. Name"  name="prof_name" value="<?php if(!empty($data['prof_name'])){ echo $data['prof_name']; }?>" />
								</div>
								
								<div class="col-sm-3">
									<label>Phone <span style="color:red">*</span> </label>
									<input  type="text" class="form-control" required  name="phone" placeholder="8989898989"  pattern="[1-9]{1}[0-9]{9}" value="<?php if(!empty($data['phone'])){ echo $data['phone']; }?>" />
								</div>
								<div class="col-sm-3">
									<label>Email <span style="color:red">*</span> </label>
									<input  type="email" class="form-control" required  name="email" placeholder="Email"  autocomplete="off" value="<?php if(!empty($data['email'])){ echo $data['email']; }?>" />
								</div>
							...
							<div class="col-sm-3">
									...
									<input  type="text" class="form-control"  name="alt_phone" placeholder="8989898989"  pattern="[1-9]{1}[0-9]{9}" value="<?php if(!empty($data['alt_phone'])){ echo $data['alt_phone']; }?>" />
								</div>
							</div><br>
