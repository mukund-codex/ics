<?php
	...
	$pageURL = 'other-studentacademic-add.php';
   ...
   $removeSelectedtabs = $admin->removeSelectedTabs();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addStudentAcademic($_POST,$_FILES,'Other');
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueStudentAcademicById($id , 'Other');
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateStudentAcademic($_POST,$_FILES,'Other');
						...
						<div class="row">
							...
							<div class="row">
								<div class="col-sm-6">
									...
									?>
										Previous Image : <br><img src="../img/StudentAcademic/postgraduate/<?php echo $file_name.'_crop.'.$ext ?>" width="100"  /><br><br>
									<?php
									} ?>
								</div>
