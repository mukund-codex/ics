<?php
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueHowWeDoById($id);
	}
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			$allowed_ext = array('image/jpeg','image/jpg','image/png');
			$id = trim($admin->escape_string($admin->strip_all($_POST['id'])));
			$result = $admin->updateHowWeDo($_POST,$_FILES);
							...
							<div class="row">
								...
								<div class="col-sm-4">
									...
									<span class="help-text">
										...
										Images must be exactly <strong>60x119</strong> pixels.
									</span>
									<br>
