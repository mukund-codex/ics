<?php
	...
	$pageURL = 'footer-links-master.php';


	$addURL_footer = 'footer-links-add.php';
	$deleteURL_footer = 'footer-links-delete.php';
	...
	//footer
	$sqlAdmission = "SELECT * FROM `dc_footer_quick_link` 
	UNION
	SELECT * FROM `dc_footer_our_inst`
	UNION
	SELECT * FROM `dc_footer_admission` ";
		...
		if(isset($_GET['deletefail'])){ ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h6 class="panel-title"><i class="icon-stats"></i>Footer</h6>
                </div>
                <div class="panel-body">
                    <a href="<?php echo $addURL_footer; ?>" class="label label-primary pull-right">Add
                    Footer</a>
                    <?php 
...
?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo $addURL_footer; ?>?edit&category=<?php echo $row['type'];?>&id=<?php echo $row['id']; ?>"
                                            name="edit" class="" title="Click to edit this row"><i
                                                class="icon-pencil"></i></a>
                                        <a class="" href="<?php echo $deleteURL_footer; ?>?category=<?php echo $row['type'];?>&id=<?php echo $row['id']; ?>"
