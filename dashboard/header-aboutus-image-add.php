<?php
	...
	$pageURL = 'header-aboutus-image-add.php';
    // echo $_GET['id'];exit();
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addHeaderDataImages($_POST,$_FILES);
	...
	if(isset($_GET['edit'])){
        ...
        // echo $id;exit;
		$data = $admin->getUniqueHeaderDataImagesById($id);
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateHeaderDataImages($_POST,$_FILES);
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i> Header About Us Images Add</h6>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
									...
									?>
                                    <img src="../img/headers/<?php echo $file_name.'_crop.'.$ext ?>" width="300"
                                        height="200" style="padding-bottom:20px"/>
