<?php
	...
	$pageName = "About Sanstha";
	$parentPageURL = 'headercontent-master.php';
	$pageURL = 'about-sanstha-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addAboutSanstha($_POST,$_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueAboutSansthaById($id);
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateAboutSanstha($_POST ,$_FILES);
