<?php
	...
	$pageURL = 'postg-add-title-description.php';
    // echo $_GET['id'];exit();
   ...
   // exit;
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			// print_r($_POST);exit;
			$result = $admin->addDepartmentTitleDes($_POST,$type);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueDepartmentTitleDesById($id);
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateDepartmentTitleDes($_POST);
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i> TiTle & Descriptions Add</h6>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <label>Title </label>
                                    <textarea col="5" rows="4" class="form-control" name="title"
                                        id="" /><?php if(!empty($data['title'])){ echo $data['title']; }?></textarea>

                                </div>

                                <div class="col-sm-6">
                                    <label>Description </label>
                                    <textarea col="5" rows="4" class="form-control" name="description"
