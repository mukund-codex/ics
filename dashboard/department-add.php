<?php
   ...
   // exit;
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueDepartmentDataById($id);
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateDepartmentData($_POST,$_FILES);
...
<body class="sidebar-wide">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
									...
									?>
                                    <embed src="../img/pdf/<?php echo $file_name.'.'.$ext ?>" width="400px"
                                        height="330px" />
                                    <?php
									} ?>
    ...
    var editor = CKEDITOR.replace('image_text', {
        height: 200,
        filebrowserImageBrowseUrl: 'js/editor/ckfinder/ckfinder.html?type=Images',
        filebrowserImageUploadUrl: 'js/editor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
        toolbarGroups: [
