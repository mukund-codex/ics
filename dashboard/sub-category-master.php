<?php
	...
	$sql = "SELECT * FROM ".PREFIX.$tableName." where category_id='$category_id' order by display_order ASC";
...
?>
							<tr>
								<td><?php echo $x++; ?></td>
								<td><img src="../img/cat-banner/<?php echo $file_name.'_crop.'.$ext ?>" width="100" /></td>
								<td><?php echo $row['sub_category_name']; ?></td>
								<td><?php echo $row['active']; ?></td>
								<td><?php echo $row['display_order']; ?></td>
								<td>
									
									<a href="<?php echo $addURL; ?>?edit&id=<?php echo $row['id'] ?>&category_id=<?php echo $category_id ?>" name="edit" class="" title="Click to edit this row"><i class="icon-pencil"></i></a>
							
									<a class="" href="<?php echo $deleteURL; ?>?id=<?php echo $row['id']; ?>&category_id=<?php echo $category_id ?>" onclick="return confirm('Are you sure you want to delete?');" title="Click to delete this row, this action cannot be undone."><i class="icon-remove3"></i></a>
