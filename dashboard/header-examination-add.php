<?php
	...
	$pageURL = 'header-examination-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			...
			$result = $admin->addExamination($_POST,$_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueExaminationById($id,$category);
	}
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
            ...
            $category = $admin->escape_string($admin->strip_all($_GET['category']));
			$result = $admin->updateExamination($_POST ,$_FILES,$category);
            ...
            <form role="form" action="" method="post" id="form" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="panel-title"><i class="icon-library"></i>Add Examination</h6>
                    </div>
