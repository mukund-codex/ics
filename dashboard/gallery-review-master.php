<?php
	...
	// print_r($admin->fetch($getAlltabs));exit();
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
								...
								<div class="col-sm-6">
									<label>Text </label>
									<textarea col="5" rows="4" class="form-control" name="text"
                                        id="" /><?php if(!empty($data['text'])){ echo $data['text']; }?></textarea>

                                </div>
								<div class="col-sm-6">
									<label>Image </label>
                                        <input type="file" class="form-control" name="image"
                                            value="<?php if(!empty($data['image'])){ echo $data['image']; }?>" />

                                </div>
								<div class="col-sm-6">
									<label>Image Test </label>
                                        <input type="text" class="form-control" name="image_text"
                                            value="<?php if(!empty($data['image_text'])){ echo $data['image_text']; }?>" />

                                </div>
								<div class="col-sm-6">
									<label>Pdf </label>
                                        <input type="file" class="form-control" name="pdf"
                                            value="<?php if(!empty($data['pdf'])){ echo $data['pdf']; }?>" />
...
?>
                                <tr>
                                    <td><?php echo $x++; ?></td>
                                    <td><img src="../img/gallery/<?php echo $file_name.'_crop.'.$ext ?>" width="100" />
                                    </td>
...
?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="add-client-review.php?edit&id=<?php echo $row['id'] ?>" name="edit"
                                            class="" title="Click to edit this row"><i class="icon-pencil"></i></a>
                                        <a class="" href="delete-client-review.php?id=<?php echo $row['id']; ?>"
                                            onclick="return confirm('Are you sure you want to delete?');"
                                            title="Click to delete this row, this action cannot be undone."><i
                                                class="icon-remove3"></i></a>
                                    </td>
...
?>
    ...
    <script>
    function getTabsName(id, elementValue) {
		console.log(elementValue.value.toLowerCase());
        document.getElementById(id).style.display = elementValue.value == elementValue.value ? 'block' : 'none';
    }
    </script>
</body>
