<?php
	...
	class Functions extends Database {
		...
		function getAllBanners() {
			$query = "select * from ".PREFIX."banner_master   order by display_order ASC";
			$sql = $this->query($query);
			return $sql;
		}
		...
		function getGalleryLastestContent(){
			$query = "select * from ".PREFIX."gallery_content where created = (select  MAX(created) from ".PREFIX."gallery_content)  ORDER BY id DESC LIMIT 1";
			return $this->fetch($this->query($query));
		}
